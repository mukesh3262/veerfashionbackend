...
export default function SubAdminList({
    ...
    const cols = [
        ...
        ...(auth?.permissions?.includes(Permission.SUB_ADMIN_EDIT) ||
        auth?.permissions?.includes(Permission.SUB_ADMIN_VIEW) ||
        auth?.permissions?.includes(Permission.SUB_ADMIN_DELETE)
            ? [
                  {
                      field: 'action',
                      title: 'Action',
                            ...
                            {({ value }) => (
                                <Action
                                    ...
                                    show={{
                                        ...
                                        permission: Permission.SUB_ADMIN_VIEW,
                                    }}
                                    edit={{
                                        href: route(
                                            'admin.admins.edit',
