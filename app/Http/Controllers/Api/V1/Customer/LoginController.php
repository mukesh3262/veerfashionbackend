...
class LoginController extends Controller
{
    public function login(LoginRequest $request, IssueTokenAction $issueToken): JsonResponse
    {
        try {
            ...
            $user = User::query()
                ->select('id', 'first_name', 'last_name', 'stripe_customer_id', 'email', 'isd_code', 'mobile', 'mobile_verified_at', 'email_verified_at', 'password', 'is_active', 'is_push_enabled', 'profile_photo')
